...
#print("abc")
print("abc"+chr(8)+chr(9)+chr(11)+"efg")
exit(0)
...
def parse_prog_arguments():
    ...
    try:
        ...
        if len(opts) > 1 and ("--help", '') in opts or len(rest):
            print("error on line:", getframeinfo(currentframe()).lineno, file=sys.stderr)
